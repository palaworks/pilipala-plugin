...
type CommentCache(renderBuilder: ICommentRenderPipelineBuilder, modifyBuilder: ICommentModifyPipelineBuilder) =

    //TODO 引入缓存容量

    let gen (renderBuilder: BuilderItem<_, _>) (modifyBuilder: BuilderItem<_>) =
